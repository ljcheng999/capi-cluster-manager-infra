...
module "eks_upstream_vpc" {
  ...
  public_subnet_ipv6_prefixes   = [for i, content in local.public_subnets : i]
  private_subnet_ipv6_prefixes  = [for i, content in local.private_subnets : i + 3]
